...
const ChartTooltipContent = React.forwardRef(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const value = !labelKey && typeof label === "string" ? itemConfig?.label || label : itemConfig?.label || item.name
...
// Utility function to get config from payload
function getPayloadConfigFromPayload(payload, key) {
  ...
  if (
    ...
    "config" in payloadPayload &&
    payloadPayload.config &&
    typeof payloadPayload.config === "object" &&
    key in payloadPayload.config
  ) {
    return payloadPayload.config[key]
  }
